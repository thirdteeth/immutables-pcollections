...
import org.thirdteeth.immutables.pcollections.examples.ImmutableExamplePBagType;

import java.util.HashSet;
import java.util.Set;


public final class ExamplePBagTest
{
  @Test
  public void testAdd()
  {
    final ImmutableExamplePBagType.Builder b =
            ImmutableExamplePBagType.builder();

    b.addIntegers(Integer.valueOf(0));
    b.addIntegers(Integer.valueOf(1));
    b.addIntegers(Integer.valueOf(2));

    final ImmutableExamplePBagType a0 = b.build();
  ...
  public void testSet()
  {
    ...
    PBag<Integer> pBag = HashTreePBag.from(integersSet);
    b.integers(pBag);
