...
import org.thirdteeth.immutables.pcollections.examples.ImmutableExamplePSetType;

import java.util.HashSet;
import java.util.Set;


public final class ExamplePSetTest
{
  @Test
  public void testAdd()
  {
    final ImmutableExamplePSetType.Builder b =
            ImmutableExamplePSetType.builder();

    b.addIntegers(Integer.valueOf(0));
    b.addIntegers(Integer.valueOf(1));
    b.addIntegers(Integer.valueOf(2));

    final ImmutableExamplePSetType a0 = b.build();
